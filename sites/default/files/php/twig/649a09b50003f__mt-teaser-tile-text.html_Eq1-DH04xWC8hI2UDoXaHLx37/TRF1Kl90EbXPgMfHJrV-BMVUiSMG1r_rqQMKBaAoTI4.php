...
/* @baseplus/partials/_mt-teaser-tile-text.html.twig */
class __TwigTemplate_8a2581ae3a6a90692a9ca985bcd368da extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        if ( !($context["page"] ?? null)) {
            // line 30
            echo "    <h4";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "node__title mt-0 mb-3"], "method", false, false, true, 30), 30, $this->source), "html", null, true);
            echo ">
      <a href=\"";
            // line 31
  ...
  ";
      ...
      ";
            // line 41
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["author_picture"] ?? null), 41, $this->source), "html", null, true);
            echo "
      <span";
            // line 42
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["author_attributes"] ?? null), "addClass", [0 => "node__submitted"], "method", false, false, true, 42), 42, $this->source), "html", null, true);
            echo ">
        ";
            // line 43
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["metadata"] ?? null), 43, $this->source), "html", null, true);
            echo "
        ";
            // line 44
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["author_name"] ?? null), 44, $this->source), "html", null, true);
            echo "
      </span>
    </div>
  ";
...
";
    ...
    {
        return "@baseplus/partials/_mt-teaser-tile-text.html.twig";
    }
    ...
    {
        return array (  149 => 48,  142 => 44,  138 => 43,  134 => 42,  130 => 41,  127 => 40,  125 => 39,  119 => 36,  115 => 35,  112 => 34,  104 => 31,  99 => 30,  97 => 29,  94 => 28,  90 => 26,  84 => 23,  81 => 22,  78 => 21,  72 => 18,  69 => 17,  66 => 16,  60 => 14,  58 => 13,  55 => 12,  53 => 11,  48 => 9,  44 => 8,  39 => 7,);
    }

    public function getSourceContext()
    {
        return new Source("", "@baseplus/partials/_mt-teaser-tile-text.html.twig", "/var/www/meridianpress.ca/web/themes/custom/baseplus/templates/partials/_mt-teaser-tile-text.html.twig");
    }
